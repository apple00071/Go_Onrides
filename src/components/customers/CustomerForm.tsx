  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="temp_address_city" className="block text-sm font-medium text-gray-700">
                      City
                    </label>
                    <input
                      type="text"
                      id="temp_address_city"
                      name="temp_address_city"
                      value={formData.temp_address_city || ''}
                      onChange={handleChange}
                      className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    <label htmlFor="temp_address_state" className="block text-sm font-medium text-gray-700">
                      State
                    </label>
                    <input
                      type="text"
                      id="temp_address_state"
                      name="temp_address_state"
                      value={formData.temp_address_state || ''}
                      onChange={handleChange}
                      className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                    />
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="perm_address_city" className="block text-sm font-medium text-gray-700">
                      City
                    </label>
                    <input
                      type="text"
                      id="perm_address_city"
                      name="perm_address_city"
                      value={formData.perm_address_city || ''}
                      onChange={handleChange}
                      className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    <label htmlFor="perm_address_state" className="block text-sm font-medium text-gray-700">
                      State
                    </label>
                    <input
                      type="text"
                      id="perm_address_state"
                      name="perm_address_state"
                      value={formData.perm_address_state || ''}
                      onChange={handleChange}
                      className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                    />
                  </div>
        ...
        <div className="px-4 sm:px-6 py-4 bg-gray-50 flex flex-col sm:flex-row items-center justify-end gap-3 sm:gap-4">
          <button
            type="button"
            onClick={() => router.back()}
