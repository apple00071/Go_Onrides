...
export default function CompleteBookingModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Original booking amount + damage charges
      const finalTotalAmount = currentBooking.booking_amount + damageCharges;

      // Calculate remaining amount to be paid
      const remainingAmount = finalTotalAmount - currentBooking.paid_amount;

      // If there's a remaining amount, create a payment record
      ...
      console.log('Completing booking with amounts:', {
        ...
        refundAmount,
        finalTotalAmount,
        paidAmount: finalTotalAmount // Set paid amount to finalTotalAmount
      });
      ...
      const { error: bookingUpdateError } = await supabase
        ...
        .update({
          ...
          paid_amount: finalTotalAmount, // Set paid amount to finalTotalAmount
